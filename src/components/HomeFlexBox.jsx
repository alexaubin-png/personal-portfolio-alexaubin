...
export default function homeFlexBox() {
  ...
  <div className="container-flex">
      ...
      <p className='box1-p'>View my written article!<button>here</button></p>
      </div>
   
    <div className='box2'>Partners
      <a className='hyperLinkBox2' href='https://sagepvp.org/'></a>
      <p className='box2-p'>View sagepvps beautiful website.<br></br><button>here</button></p>
    </div>
    <div className='box3'> github<br></br>alexaubinpng
      <a className='hyperLinkBox3' href='https://github.com/alexaubin-png'></a>
      <p className='box3-p'>Immerse into my open source projects.<br></br><button>here</button></p>
    </div>
    <div className='box4'>Youtube Channel
      ...
      <p className='box4-p'>Checkout my youtube videos!<br></br><button>here</button></p>
    </div>
  </div>
  </div>
  </> 
